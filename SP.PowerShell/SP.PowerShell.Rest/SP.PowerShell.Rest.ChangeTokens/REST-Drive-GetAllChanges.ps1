...
function SPSite-GetAllChanges {
    ...
    begin {
        ...
        $requestUrl = "{0}/_api/web/GetChanges" -f $SiteUrl, $LibraryName
    ...
    process {
        do {
            Write-Output ("Calling {0} with {1}" -f $requestUrl, $listItemCollectionPositionNext)
        ...
        Write-Output ("LastChangeToken: {0}" -f $LastChangeToken)
    }
}